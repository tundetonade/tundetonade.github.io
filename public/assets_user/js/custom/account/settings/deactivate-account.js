                ...
                fields: {
				 ...
				 fields: {
                    activate: {
                        validators: {
                            notEmpty: {
                                message: 'Please check the box to verify your account'
                            }
                        }
                    }
                },
        ...
        submitButton.addEventListener('click', function (e) {
            ...
            validation.validate().then(function (status) {
                if (status == 'Valid') {
                    ...
                    swal.fire({
                        text: "Are you sure you would like to verify this account?",
                        icon: "warning",
                        ...
                        if (result.isConfirmed) {
                            Swal.fire({
                                text: 'Acccount will now proceed with verification.', 
                                icon: 'success',
