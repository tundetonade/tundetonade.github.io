...
var KTModalNewTicket = function () {
			...
			form,
			{
				fields: {
					...
					nhf: {
						validators: {
							notEmpty: {
								message: 'NHF Status is Required'
							}
						}
					},
					nhis: {
						validators: {
							notEmpty: {
								message: 'NHIS Status is Required'
							}
						}
					},
					pension: {
                        validators: {
                            notEmpty: {
                                message: 'Pension Status is Required'
                            }
                        }
                    },
				},
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_ticketreg');
			...
			form = document.querySelector('#kt_modal_new_ticketreg_form');
			submitButton = document.getElementById('kt_modal_new_ticketreg_submit');
			cancelButton = document.getElementById('kt_modal_new_ticketreg_cancel');
