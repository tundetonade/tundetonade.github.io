...
var KTModalNewTicket = function () {
			...
			form,
			{
				fields: {
					secondary_school_certificate: {
						validators: {
							notEmpty: {
								message: 'You Must Upload Secondary School Certificate'
							}
						}
					},
				primary_school_certificate: {
						validators: {
							notEmpty: {
								message: 'You Must Upload Primary School Certificate'
							}
						}
					},
					weight: {
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_secondary');
			...
			form = document.querySelector('#kt_modal_new_secondary_form');
			submitButton = document.getElementById('kt_modal_new_secondary_submit');
			cancelButton = document.getElementById('kt_modal_new_secondary_cancel');
