...
<head>
		<title>Order For Books::REDDOT</title>
		<meta charset="utf-8" />
										...
										<div class="modal-dialog modal-dialog-centered mw-950px">
											...
											<div class="modal-content rounded">
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													<!--begin:Form-->
													<form id="kt_modal_new_ticket_form" method="POST" class="form" action="InsertOrders" onsubmit="return confirm('Are you sure you want to order these books?');">
    ...
    <div id="books_container">
        <div class="book_entry d-flex flex-wrap align-items-center justify-content-between mb-8 fv-row">
            <div class="d-flex flex-column mb-4">
                <label class="required fs-6 fw-semibold mb-2"><span style="color:#ff0000;">Select Book</span></label>
                <select name="book_name[]" class="form-select form-select-solid" data-hide-search="true" required>
            ...
            <div class="d-flex flex-column mb-4">
                ...
                <input type="number" class="form-control form-control-solid quantity" name="quantity[]" required oninput="calculateTotal(this)" required>
            </div>
									...
									<div class="modal fade" id="kt_modal_new_ticket_receive" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-950px">
											...
											<div class="modal-content rounded">
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													<!--begin:Form-->
													<form id="kt_modal_new_ticket_form" method="POST" class="form" action="InsertOrders" onsubmit="return confirm('Are you sure you want to order these book(s)?');">
    <div class="mb-13 text-center">
