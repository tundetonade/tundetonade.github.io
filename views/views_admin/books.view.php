									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="card-px text-center pt-15 pb-15">
												<!--begin::Title-->
												<h2 class="fs-2x fw-bold mb-0">List of Books</h2><br>
												<a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket" class="btn btn-primary fw-bold fs-8 fs-lg-base">Add New Book</a>
										...
										<div class="modal-dialog modal-dialog-centered mw-750px">
											...
											<div class="modal-content rounded">
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													<!--begin:Form-->
													<form id="kt_modal_new_ticket_form" method="POST" class="form" action="InsertBooks" onsubmit="return confirm('Are you sure you want to add this book?');">
														<!--begin::Heading-->
													...
													<!--	<div class="d-flex flex-column mb-8 fv-row" id="txtHint">-->
															...
															<!--begin::Input group-->
														<div class="d-flex flex-column mb-8 fv-row">
														<label class="required fs-6 fw-semibold mb-2"><span style="color:#ff0000;">Description / Name of Book</span></label>
																<input type="text" class="form-control form-control-solid" name="book_name" required>
														...
														<!--begin::Input group-->
															...
															<!--begin::Input group-->
														<div class="d-flex flex-column mb-8 fv-row">
														<label class="required fs-6 fw-semibold mb-2"><span style="color:#ff0000;">Author Name</span></label>
															<!--end::Input group-->
														...
														<div class="d-flex flex-column mb-8 fv-row">
														<label class="required fs-6 fw-semibold mb-2"><span style="color:#ff0000;">ISBN NO</span></label>
																<input type="text" class="form-control form-control-solid" name="isbn_no" required>
														...
														<div class="text-center">
															...
															<button type="submit" id="kt_modal_new_ticket_submit" class="btn btn-primary">
																<span class="indicator-label">Add Book</span>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
												...
												<thead>
													...
													<tr class="text-start fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px"><font color="#0000ff"><strong>Description/Book</strong></font></th>
														<th class="min-w-100px"><font color="#0000ff"><strong>ISBN NO</strong></font></th>
														<th class="min-w-100px"><font color="#0000ff"><strong>Author</strong></font></th>
														<th class="min-w-100px"><font color="#0000ff"><strong>Registered By</strong></font></th>
														<th class="min-w-100px"><font color="#0000ff"><strong>Date Time</strong></font></th>
												...
												<tbody class="fw-semibold">
													...
													<tr>
														...
														<td>
															<span><?php echo $value['isbn_no']; ?></span>
														</td>
														<td>
														...
														<td>
															<span><?php echo $value['registered_by']; ?></span>
														</td>
