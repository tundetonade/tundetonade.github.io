...
<head>
		<title>View/Register Depots</title>
		<meta charset="utf-8" />
										...
										<div class="modal-dialog modal-dialog-centered mw-750px">
											...
											<div class="modal-content rounded">
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													<!--begin:Form-->
													<form id="kt_modal_new_ticket_form" method="POST" class="form" action="InsertDepot">
														<!--begin::Heading-->
														<div class="mb-13 text-center">
															<!--begin::Title-->
															<h1 class="mb-3">Register New Depot</h1>
															<!--end::Title-->
															<!--begin::Description-->
														...
														<label class="required fs-6 fw-semibold mb-2">Depot Name</label>
																<input type="text" class="form-control form-control-solid" name="name" placeholder="Enter Depot Name" required>
    ...
    <option value="Zamfara">Zamfara</option>
														...
														<div class="text-center">
															...
															<button type="submit" id="kt_modal_new_ticket_submit" class="btn btn-primary">
																<span class="indicator-label">Register Depot</span>
									...
									<h2>List of Depots</h2>
										...
										<br>
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												...
												<!--end::Filter-->
												<a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket" class="btn btn-primary fw-bold fs-8 fs-lg-base">Register Depot</a>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
												...
												<thead>
													...
													<tr class="text-start fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px"><font color="#0000ff"><strong>Depot Name</strong></font></th>
												...
												<tbody class="fw-semibold">
													...
													<tr>
														...
														<!--begin::SKU=-->
														<td>
															<span><?php echo $value['depot_name']; ?></span>
														</td>
														<td>
