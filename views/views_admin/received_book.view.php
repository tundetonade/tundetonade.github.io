											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
												...
												<thead>
													...
													<tr class="text-start fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px"><font color="#0000ff"><strong>Received By</strong></font></th>
														<th class="min-w-100px"><font color="#0000ff"><strong>Date</strong></font></th>
												...
												<tbody class="fw-semibold">
													<!--begin::Table row-->
													<?php $i=0; ?>
													<?php foreach($receivedBooks as $value){ ?>
													<?php $i++ ?>
													<tr>
														<!--begin::Product=-->
														<td>
														...
														<td>
															<span><?php echo $value['received_by']; ?></span>
														</td>
