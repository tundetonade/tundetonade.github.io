...
<head>
		<title>Distribute Books::REDDOT</title>
		<meta charset="utf-8" />
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="card-px text-center pt-15 pb-15">
												<!--begin::Title-->
												<h2 class="fs-2x fw-bold mb-0">Distribute Books</h2><br>
												<a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket" class="btn btn-primary fw-bold fs-8 fs-lg-base">Distribute Now</a>
										...
										<div class="modal-dialog modal-dialog-centered mw-950px">
											...
											<div class="modal-content rounded">
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													<!--begin:Form-->
<form id="kt_modal_new_ticket_form" method="POST" class="form" action="InsertDistributed" onsubmit="return confirm('Are you sure you want to distribute these books?');">
    ...
    <div class="d-flex flex-column mb-4" style="width: 50%;">
        ...
        <input type="number" name="quantity[]" class="form-control form-control-solid" max="<?php echo $value['quantity']; ?>" required style="width: 100%;">
    </div>
</div>
    ...
    <div class="text-center">
        ...
        <button type="submit" id="kt_modal_new_ticket_submit" class="btn btn-primary">
            <span class="indicator-label">Distribute Books</span>
