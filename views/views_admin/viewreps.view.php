...
<head>
		<title>View/Register Reps</title>
		<meta charset="utf-8" />
										...
										<div class="modal-dialog modal-dialog-centered mw-750px">
											...
											<div class="modal-content rounded">
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													<!--begin:Form-->
													<form id="kt_modal_new_ticket_form" method="POST" class="form" action="InsertRep">
														<!--begin::Heading-->
														<div class="mb-13 text-center">
															<!--begin::Title-->
															<h1 class="mb-3">Register New Rep</h1>
															<!--end::Title-->
															<!--begin::Description-->
														...
														<label class="required fs-6 fw-semibold mb-2">Rep Name</label>
																<input type="text" class="form-control form-control-solid" name="name" placeholder="Enter Rep Name" required>
																
														</div>
														
														<div class="d-flex flex-column mb-8 fv-row">
														<label class="required fs-6 fw-semibold mb-2">Email</label>
																<input type="email" class="form-control form-control-solid" name="email" placeholder="Enter Rep Email" required>
														...
														<label class="required fs-6 fw-semibold mb-2">Phone</label>
																<input type="phone" class="form-control form-control-solid" name="phone" placeholder="Enter Rep Phone" required>
																
														</div>
														
														
															<div class="d-flex flex-column mb-8 fv-row">
														<label class="required fs-6 fw-semibold mb-2">Select Depot/Location</label>
																<select class="form-control form-control-solid" name="location" placeholder="Enter Address" required>
    <option value="">Select Depot/Location</option>
	<?php foreach($locations as $value){ ?>
	<option value="<?php echo $value['depot_name'] . ' / ' . $value['location']; ?>"><?php echo $value['depot_name']; ?> / <?php echo $value['location']; ?> </option>
	<?php } ?>
														...
														<!--end::Input group-->
															...
															<div  id="kt_modal_create_ticket_attachments">
														...
														<div class="text-center">
															...
															<button type="submit" id="kt_modal_new_ticket_submit" class="btn btn-primary">
																<span class="indicator-label">Register Rep</span>
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									...
									<div class="col-xl-8 mb-5 mb-xl-10">
									 <form  method="post" action="ViewAdmin" enctype="multipart/form-data">
									...
									<h2>List of Reps</h2>
										...
										<br>
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												...
												<!--end::Filter-->
												<a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket" class="btn btn-primary fw-bold fs-8 fs-lg-base">Register Rep</a>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
												...
												<thead>
													...
													<tr class="text-start fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-100px"><font color="#0000ff"><strong>Rep Name</strong></font></th>
														<th class="min-w-100px"><font color="#0000ff"><strong>Location</strong></font></th>
