<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							...
							<center>
							<a href="Dashboard">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img alt="Logo" src="../public/assets_user/media/logos/logo.png" width="80px"" />
								<img alt="Logo" src="../public/assets_user/media/logos/logo.png" class="h-20px app-sidebar-logo-minimize" />
							</a></center>
		 ...
		 <!-- <input type="submit">-->
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<span class="menu-link">
											...
											<span class="menu-title">Inventory Manager</span>
											<span class="menu-arrow"></span>
										</span>
										<!--end:Menu link-->
										<!--begin:Menu sub-->
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="OrderBooks">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Order For Books</span>
												</a>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="ReceivedBooks">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Received Books</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="DistributeBooks">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Distribute Books</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<!--<div class="menu-item">
												...
												<a class="menu-link" href="ByDemandNotice">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Demand Notice</span>
												</a>
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="Books">
													...
													<span class="menu-title">Request For Books</span>
												</a>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="RequestBooks">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Request For Books</span>
